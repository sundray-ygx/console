...
// Use Vite's ?url import to properly resolve the worker file path
...
// Session-level blob cache for PDFs keyed by src URL
...
async function loadPdf() {
  ...
  try {
    ...
    if (!data) {
      // Fetch as blob with progress tracking
    ...
    loadingMessage.value = `渲染第 ${currentPage.value}/${totalPages.value} 页`
